...
export default function Register() {
    ...
    return (
        <AuthLayout title={locale['Create an account']} description={locale['Enter your details below to create your account']}>
            <Head title={locale.Register} />
            <form className="flex flex-col gap-6" onSubmit={submit}>
                ...
                <div className="text-muted-foreground text-center text-sm">
                    {locale['Already have an account']}?{' '}
