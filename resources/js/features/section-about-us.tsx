...
export const SectionAboutUs = () => {
    ...
    return (
        <section className="mx-auto max-w-[1640px] space-y-8 p-4 md:px-8 xl:px-12" id="about">
            <RootHeading
                title={locale['About Us']}
                description={
                    locale['Learn more about our mission, values, and the dedicated team working to deliver exceptional solutions for our customers']
                }
            />
            <p className="max-w-[1200px] text-center text-sm md:text-left md:text-base lg:text-lg">
                {locale.At} <span className="font-bold">Juz Wystawiam</span>,{' '}
                {
                    locale[
                        'we believe that success is built on a foundation of trust, innovation, and dedication. Established with a vision to make a positive impact, our company has consistently focused on delivering high-quality solutions tailored to the unique needs of our clients. Our journey began with a small team of passionate individuals, and over the years, we have grown into a dynamic organization driven by creativity and a commitment to excellence'
                    ]
                }
            </p>
